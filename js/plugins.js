...
function(e) {
  ...
  y.prototype = {
    ...
    open: function(n) {
      ...
      t.bgOverlay || (t.bgOverlay = x("bg").on("click" + g,
      function() {
        t.close()
      }), t.wrap = x("wrap").attr("tabindex", -1).on("click" + g,
      function(e) {
      ...
      k("BeforeOpen"),
      t.st.showCloseBtn && (t.st.closeBtnInside ? (I(u,
      function(e, t, n, i) {
      ...
      t.st.enableEscapeKey && i.on("keyup" + g,
      function(e) {
  ...
  e.magnificPopup.registerModule("gallery", {
    ...
    proto: {
      initGallery: function() {
        ...
        n && n.enabled ? (r += " mfp-gallery", I(p + o,
        function() {
